  ...
  return (
    <div className="w-[13.5rem] h-full border-r bg-white dark:bg-gray-800 flex flex-col">
      ...
      <div className="p-3 flex items-center justify-between">
        ...
        <button 
          onClick={onToggle}
          className="ml-2 p-1 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer"
          title="收起聊天侧边栏"
        >
      ...
      <div className="overflow-y-auto">
        ...
        {/* Claude 3.7 Sonnet */}
        <div className="flex items-center p-3 bg-gray-50 dark:bg-gray-700 cursor-pointer">
          ...
          <Star className="w-4 h-4 ml-auto text-blue-500 fill-blue-500" />
        </div>
        ...
        {/* GPT-4o */}
        <div className="flex items-center p-3 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer">
          <div className="w-6 h-6 rounded-full bg-gray-800 flex items-center justify-center mr-2"></div>
